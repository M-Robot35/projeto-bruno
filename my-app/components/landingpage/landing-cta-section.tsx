      ...
      <div className="container relative px-4 md:px-6">
        ...
        >
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row">
            ...
            <Link href="https://wa.me/31998237665?text=Quero%20experimentar%20por%203%20dias" target="_blank" rel="noopener noreferrer" passHref>
              <Button
                size="lg"
            ...
            <Link href="https://wa.me/31998237665?text=Quero%20agendar%20uma%20demonstração" target="_blank" rel="noopener noreferrer" passHref>
            <Button
              size="lg"
              variant="outline"
