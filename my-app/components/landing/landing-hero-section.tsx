          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_650px]">
            ...
            >
              <div className="space-y-2">
                <div className="inline-flex items-center rounded-full border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/50 px-3 py-1 text-sm text-emerald-700 dark:text-emerald-300 mb-4">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                ...
                <Link href="https://wa.me/31985019300?text=Quero%20agendar%20uma%20demonstração" target="_blank" rel="noopener noreferrer" passHref>
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="group border-emerald-200 dark:border-emerald-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/50 transition-all duration-300"
                  >
            ...
            >
              <div className="relative w-full h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] overflow-hidden rounded-xl border dark:border-border bg-background dark:bg-background p-1 md:p-2 lg:p-3 shadow-xl dark:shadow-2xl dark:shadow-emerald-950/10">
                {/* Botões de janela */}
                ...
                {/* Fundo da tela */}
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/20 dark:to-background/80"></div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative z-10 w-full h-full flex items-center justify-center">
                    ...
                    <div className="relative w-[180px] h-[350px] md:w-[200px] md:h-[380px] lg:w-[220px] lg:h-[400px] animate-float">
                      {/* Ícones flutuantes */}
                      <div className="absolute -right-6 -top-10 flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-lg dark:shadow-emerald-900/20 animate-pulse-slow">
                        <MessageCircle className="h-5 w-5 text-emerald-500 dark:text-emerald-400" />
                      </div>
                      <div
                        className="absolute -left-6 -bottom-6 flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-lg dark:shadow-emerald-900/20 animate-pulse-slow"
                        style={{ animationDelay: "1s" }}
                      >
                        <Phone className="h-5 w-5 text-emerald-500 dark:text-emerald-400" />
                      </div>
                      <div
                        className="absolute -left-10 -top-5 flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-lg dark:shadow-emerald-900/20 animate-pulse-slow"
                      ...
                      {/* Smartphone frame */}
                      <div className="relative w-full h-full rounded-[24px] border-[5px] border-gray-800 dark:border-gray-900 bg-white dark:bg-gray-800 shadow-2xl dark:shadow-emerald-900/20 overflow-hidden">
                        {/* Notch do smartphone */}
                        <div className="absolute top-0 left-0 right-0 h-4 bg-gray-800 dark:bg-black flex justify-center items-end pb-1">
                          <div className="w-12 h-0.5 bg-gray-600 dark:bg-gray-700 rounded-full"></div>
                        </div>

                        {/* Conteúdo da tela */}
                        <div className="absolute top-4 left-0 right-0 bottom-0 overflow-hidden">
                          <div className="w-full h-full bg-emerald-50 dark:bg-emerald-950 flex flex-col">
                            {/* Cabeçalho do WhatsApp */}
                            <div className="h-8 bg-emerald-500 dark:bg-emerald-700 flex items-center px-2">
                              <div className="w-4 h-4 rounded-full bg-white dark:bg-gray-200 mr-1.5"></div>
                              <div className="flex flex-col">
                                <div className="h-1 w-12 bg-white/80 dark:bg-white/70 rounded-full"></div>
                                <div className="h-0.5 w-8 bg-white/60 dark:bg-white/50 rounded-full mt-0.5"></div>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 p-1.5 flex flex-col gap-1.5 overflow-hidden">
                              {/* Mensagem recebida */}
                              <div className="self-start max-w-[70%] bg-white dark:bg-gray-800 p-1.5 rounded-md rounded-tl-none shadow-sm">
                                <p className="text-[8px] font-medium text-gray-800 dark:text-gray-200">
                                  Olá! Como posso ajudar?
                                </p>
                              </div>

                              {/* Mensagem enviada */}
                              <div className="self-end max-w-[70%] bg-emerald-100 dark:bg-emerald-800 p-1.5 rounded-md rounded-tr-none mt-1">
                                <p className="text-[8px] font-medium text-emerald-800 dark:text-emerald-100">
                                  Quero realizar um pedido
                                </p>
                              </div>

                              {/* Campo de digitação simplificado */}
                              <div className="mt-auto flex items-center bg-white dark:bg-gray-800 rounded-full p-1 border border-gray-200 dark:border-gray-700 mx-1">
                                <div className="h-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full mx-auto"></div>
                              </div>
                            </div>
                          </div>
                        </div>
